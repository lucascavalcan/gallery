...
const App = () => {
  ...
  async function handleFormSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    //verfica se tem um arquivo selecionado:
    const formData = new FormData(e.currentTarget); //pegando o formulário
    const file = formData.get("image") as File;  //pegando o arquivo dentro do formulário

    if (file && file.size > 0) {
      //vai começar o processo de upload de fato
      setUploading(true);
